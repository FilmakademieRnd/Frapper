...
//!
//! \file "GraphicsView.h"
//! \brief Header file for GraphicsView class.
//!
...
//!
//!     GraphicsView [label="GraphicsView",fillcolor="grey75"];
...
//!
class FRAPPER_GUI_EXPORT GraphicsView : public QGraphicsView
{
