...
//!
//! \file "PainterPanelPlugin.h"
//! \brief Header file for PainterPanelPlugin class.
//!
...
#ifndef PAINTERPANELPLUGIN_H
#define PAINTERPANELPLUGIN_H
...
//!
class PainterPanelPlugin : public QObject, public PanelTypeInterface
{
    Q_OBJECT
