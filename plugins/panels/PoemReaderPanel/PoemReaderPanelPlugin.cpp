...
//!
//! \file "PoemReaderPanelPlugin.cpp"
//! \brief Implementation file for PoemReaderPanelPlugin class.
//!
...
{
    return new PoemReaderPanel(parent);
}


#if QT_VERSION < 0x050000
Q_EXPORT_PLUGIN2(PoemReaderPanelplugin, PoemReaderPanelPlugin)
#endif
