...
//!
//! \file "MidiTimerNodePlugin.h"
//! \brief Header file for TimerNodePlugin class.
//!
...
#ifndef MIDITIMERNODEPLUGIN_H
#define MIDITIMERNODEPLUGIN_H
...
//!
class MidiTimerNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
