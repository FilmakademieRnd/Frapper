...
//!
//! \file "PatchMatchPlugin.h"
//! \brief Header file for PatchMatch class.
//!
...
//!
//! Plugin class for creation of PatchMatchNode node.
//!
class PatchMatchPlugin : public QObject, public Frapper::NodeTypeInterface
{
    Q_OBJECT
