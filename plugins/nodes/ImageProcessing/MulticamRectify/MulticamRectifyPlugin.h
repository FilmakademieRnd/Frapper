...
#ifndef MulticamRectifyPLUGIN_H
#define MulticamRectifyPLUGIN_H
...
//!
//! Plugin class for creation of MulticamRectify node.
//!
class MulticamRectifyPlugin : public QObject, public Frapper::NodeTypeInterface
{
    Q_OBJECT
