...
//!
//! \file "CameraIntrinsicCalibrator.h"
...
//!
//! Class representing CameraIntrinsicCalibrator
//!
class CameraIntrinsicCalibrator : public ImageNode
{
    Q_OBJECT
...
public: /// constructors and destructors
    ...
    //!
    CameraIntrinsicCalibrator ( QString name, ParameterGroup *parameterRoot );
    ...
    //!
	virtual ~CameraIntrinsicCalibrator ();
