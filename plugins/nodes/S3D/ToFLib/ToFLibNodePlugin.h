...
#ifndef ToFLibNODEPLUGIN_H
#define ToFLibNODEPLUGIN_H
...
//!
//! Plugin class for creation of ToFLibNode node.
//!
class ToFLibNodePlugin : public QObject, public Frapper::NodeTypeInterface
{
    Q_OBJECT
