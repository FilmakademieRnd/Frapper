...
//!
//! Class representing OpenMvgGlobalSfM
//!
class OpenMvgGlobalSfM : public Node
{
    Q_OBJECT
...
public: /// constructors and destructors
    ...
    //!
    OpenMvgGlobalSfM ( QString name, ParameterGroup *parameterRoot );
