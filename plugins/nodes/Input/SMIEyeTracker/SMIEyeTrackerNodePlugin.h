...
//! \brief Header file for SMIEyeTrackerNodePlugin class.
//!
...
#ifndef SMIEYETRACKERNODEPLUGIN_H
#define SMIEYETRACKERNODEPLUGIN_H
...
//!
//! Plugin class for creation of SMIEyeTrackerNode node.
//!
class SMIEyeTrackerNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
