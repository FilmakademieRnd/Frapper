...
//! \brief Header file for PoemReaderNodePlugin class.
//!
...
#ifndef POEMREADERNODEPLUGIN_H
#define POEMREADERNODEPLUGIN_H
...
//!
class PoemReaderNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
