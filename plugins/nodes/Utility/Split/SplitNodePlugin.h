...
//!
//! \file "SplitNodePlugin.h"
//! \brief Header file for SplitNodePlugin class.
//!
...
#ifndef SPLITNODEPLUGIN_H
#define SPLITNODEPLUGIN_H
...
//!
class SplitNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
