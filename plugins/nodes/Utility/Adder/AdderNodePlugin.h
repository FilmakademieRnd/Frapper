...
//! \brief Header file for AdderNodePlugin class.
//!
...
#ifndef ADDERNODEPLUGIN_H
#define ADDERNODEPLUGIN_H
...
//!
class AdderNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
