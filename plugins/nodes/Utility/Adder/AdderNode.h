...
//!
//! \file "AdderNode.h"
//! \brief Header file for AdderNode class.
//!
...
public: // constructors and destructors
    ...
    //!
    AdderNode ( QString name, ParameterGroup *parameterRoot );
...
private: // data
	...
	NumberParameter *m_outParameter;
	NumberParameter *m_outRoundedParameter;

	int m_nbrInputs; // number of outputs
