...
//! \brief Header file for ParticleSystemLogicNodePlugin class.
//!
...
#ifndef PARTICLESYSTEMLOGICNODEPLUGIN_H
#define PARTICLESYSTEMLOGICNODEPLUGIN_H
...
//!
class ParticleSystemLogicNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
