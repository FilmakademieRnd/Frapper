...
#
#  FRAPPER_FIND_PACKAGE(package [VERSION_SPEC] [COMPONENTS component1 ... ] [NAMES name1 ...])
#
...
#
# FRAPPER_FIND_PACKAGE improves upon this by trying custom prefixes one at a time,
...
#
MACRO(FRAPPER_FIND_PACKAGE package)
    # parse the args
    set(COMPONENTS)
    set(NAMES)
    set(VERSION_SPEC)
