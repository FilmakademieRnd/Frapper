...
//!
//! \file "PythonNodePlugin.h"
//! \brief Header file for PythonNodePlugin class.
//!
...
#ifndef PYTHONNODEPLUGIN_H
#define PYTHONNODEPLUGIN_H
...
//!
class PythonNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
