...
//!
//! \file "S3DGameNodePlugin.h"
//! \brief Header file for S3DGameNodePlugin class.
//!
...
#ifndef S3DGAMENODEPLUGIN_H
#define S3DGAMENODEPLUGIN_H
...
//!
class S3DGameNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
