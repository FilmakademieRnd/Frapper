...
//!
//! \file "MergeNodePlugin.h"
//! \brief Header file for MergeNodePlugin class.
//!
...
#ifndef MERGENODEPLUGIN_H
#define MERGENODEPLUGIN_H
...
//!
class MergeNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
