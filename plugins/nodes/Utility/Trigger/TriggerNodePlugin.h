...
//! \brief Header file for TriggerNodePlugin class.
//!
...
#ifndef TRIGGERNODEPLUGIN_H
#define TRIGGERNODEPLUGIN_H
...
//!
class TriggerNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
