...
//!
//! \file "Float2BoolNode.h"
//! \brief Header file for Float2BoolNode class.
//!
//! \author     Diana Arellano (diana.arellano@filmakademie.de)
//! \version    1.0
//! \date       03.2015
//!
#ifndef FLOAT2BOOLNODE_H
#define FLOAT2BOOLNODE_H
...
//!
class Float2BoolNode : public Node
{
    Q_OBJECT
...
public: /// constructors
    ...
    //!
    Float2BoolNode ( QString name, ParameterGroup *parameterRoot );
