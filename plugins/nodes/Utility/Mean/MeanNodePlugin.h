...
//!
//! \file "MeanNodePlugin.h"
//! \brief Header file for MeanNodePlugin class.
//!
...
#ifndef MEANNODEPLUGIN_H
#define MEANNODEPLUGIN_H
...
//!
class MeanNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
