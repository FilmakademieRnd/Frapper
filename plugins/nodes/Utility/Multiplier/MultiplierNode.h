...
//! \brief Header file for MultiplierNode class.
//!
...
#ifndef MULTIPLIERNODE_H
#define MULTIPLIERNODE_H
...
public: // constructors and destructors
    ...
    //!
    MultiplierNode ( QString name, ParameterGroup *parameterRoot );
...
private: // data
	Parameter *m_inParameter, *m_outParameter;
	float m_multi;
	int test1;
	QHash<QString, int> test2;
	QList<int> test4;
};
