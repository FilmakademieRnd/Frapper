...
//! \brief Header file for MultiplierNodePlugin class.
//!
...
#ifndef MULTIPLIERNODEPLUGIN_H
#define MULTIPLIERNODEPLUGIN_H
...
//!
class MultiplierNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
