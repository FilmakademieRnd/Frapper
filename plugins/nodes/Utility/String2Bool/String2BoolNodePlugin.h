...
//!
//! \file "String2BoolNodePlugin.h"
//! \brief Header file for String2BoolNodePlugin class.
//!
...
#ifndef STRING2BOOLNODEPLUGIN_H
#define STRING2BOOLNODEPLUGIN_H
...
//!
class String2BoolNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
