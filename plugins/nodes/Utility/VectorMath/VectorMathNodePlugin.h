...
//! \brief Header file for VectorMathNodePlugin class.
//!
...
#ifndef VECTORMATHNODEPLUGIN_H
#define VECTORMATHNODEPLUGIN_H
...
//!
class VectorMathNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
