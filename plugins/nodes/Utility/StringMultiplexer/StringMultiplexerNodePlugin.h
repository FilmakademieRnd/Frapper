...
//! \brief Header file for StringMultiplexerNodePlugin class.
//!
...
#ifndef STRINGMULTIPLEXERNODEPLUGIN_H
#define STRINGMULTIPLEXERNODEPLUGIN_H
...
//!
class StringMultiplexerNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
