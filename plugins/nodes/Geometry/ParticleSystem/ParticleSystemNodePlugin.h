...
//! \brief Header file for ParticleSystemNodePlugin class.
//!
//! \author     Nils Zweiling <n.zweiling@unexpected>
//! \version    1.0
//! \date       07.03.2013 (last updated)
//!

#ifndef PARTICLESYSTEMNODEPLUGIN_H
#define PARTICLESYSTEMNODEPLUGIN_H
...
//!
class ParticleSystemNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
