...
#ifndef TEXTUREGEOMETRYMOVERNODEPLUGIN_H
#define TEXTUREGEOMETRYMOVERNODEPLUGIN_H
...
//!
class TextureGeometryMoverNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
