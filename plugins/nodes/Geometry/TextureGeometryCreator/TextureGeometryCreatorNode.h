...
//! \brief Header file for TextureGeometryCreatorNode class.
//!
...
#ifndef TEXTUREGEOMETRYCREATORNODE_H
#define TEXTUREGEOMETRYCREATORNODE_H
...
//!
class TextureGeometryCreatorNode : public TextureGeometryNode
{
...
public: // constructors and destructors
    ...
    //!
    //! \param name The name to give the new TextureGeometryCreatorNode node.
    //! \param parameterRoot A copy of the parameter tree specific for the type of the node.
	//! \param outputImageName the name of the output image texture
    //!
    TextureGeometryCreatorNode ( const QString &name, ParameterGroup *parameterRoot);

    //!
    //! Destructor of the TextureGeometryCreatorNode class.
    //!
    ~TextureGeometryCreatorNode ();
