...
#ifndef POSITIONBUFFERCREATORNODEPLUGIN_H
#define POSITIONBUFFERCREATORNODEPLUGIN_H
...
//!
class PositionBufferCreatorNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
