...
#ifndef TEXTUREGEOMETRYCREATORNODEPLUGIN_H
#define TEXTUREGEOMETRYCREATORNODEPLUGIN_H
...
//!
class TextureGeometryCreatorNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
