...
//! \brief Header file for MeshNodePlugin class.
//!
...
#ifndef MESHNODEPLUGIN_H
#define MESHNODEPLUGIN_H
...
//!
//! Plugin class for creation of MeshNode node.
//!
class MeshNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
