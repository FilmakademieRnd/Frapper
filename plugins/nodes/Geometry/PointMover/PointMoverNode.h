...
//! \brief Header file for PointMoverNode class.
//!
...
//!
class PointMoverNode : public PointTextureMapNode
{
...
public: // constructors and destructors
    ...
    //!
    //! \param name The name to give the new PointMoverNode node.
    //! \param parameterRoot A copy of the parameter tree specific for the type of the node.
	//! \param outputImageName the name of the output image texture
    //!
    PointMoverNode ( const QString &name, ParameterGroup *parameterRoot);
