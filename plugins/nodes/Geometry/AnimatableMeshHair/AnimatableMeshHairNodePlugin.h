...
#ifndef ANIMATABLEMESHHAIRNODEPLUGIN_H
#define ANIMATABLEMESHHAIRNODEPLUGIN_H
...
//!
//! Plugin class for creating AnimatableMeshHairNode objects.
//!
class AnimatableMeshHairNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
