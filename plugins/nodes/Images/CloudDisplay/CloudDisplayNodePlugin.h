...
//! \brief Header file for CloudDisplayNodePlugin class.
//!
...
#ifndef CLOUDDISPLAYNODEPLUGIN_H
#define CLOUDDISPLAYNODEPLUGIN_H
...
//!
class CloudDisplayNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
