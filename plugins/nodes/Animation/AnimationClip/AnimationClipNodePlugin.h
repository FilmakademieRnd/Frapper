...
//! \brief Header file for AnimationClipNodePlugin class.
//!
...
#ifndef ANIMATIONCLIPNODEPLUGIN_H
#define ANIMATIONCLIPNODEPLUGIN_H
...
//!
//! Plugin class for creation of AnimationClipNode node.
//!
class AnimationClipNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
