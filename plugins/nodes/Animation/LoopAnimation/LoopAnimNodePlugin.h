...
//!
//! \file "LoopAnimNodePlugin.h"
//! \brief Header file for LoopAnimNodePlugin class.
//!
...
#ifndef LOOPANIMNODEPLUGIN_H
#define LOOPANIMNODEPLUGIN_H
...
//!
class LoopAnimNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
