...
//!
//! \file "FadeAnimNodePlugin.h"
//! \brief Header file for FadeAnimNodePlugin class.
//!
...
#ifndef FADEANIMNODEPLUGIN_H
#define FADEANIMNODEPLUGIN_H
...
//!
class FadeAnimNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
