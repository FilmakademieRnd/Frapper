...
#ifndef LIGHTWARPINGNODEPLUGIN_H
#define LIGHTWARPINGNODEPLUGIN_H
...
//!
//! Plugin class for creating LightWarpingNode objects.
//!
class LightWarpingNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
