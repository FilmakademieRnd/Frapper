...
//! \brief Header file for NetworkAnimNodePlugin class.
//!
...
#ifndef NETWORKANIMNODEPLUGIN_H
#define NETWORKANIMNODEPLUGIN_H
...
//!
//! Plugin class for creation of NetworkAnimNode node.
//!
class NetworkAnimNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
