...
//!
//! \file "StereoCameraPlugin.h"
//! \brief Header file for StereoCameraPlugin class.
//!
...
#ifndef STEREOCAMERAPLUGIN_H
#define STEREOCAMERAPLUGIN_H
...
//!
class StereoCameraPlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
