...
//! \brief Header file for HeadLogicNodePlugin class.
//!
...
#ifndef HEADLOGICNODEPLUGIN_H
#define HEADLOGICNODEPLUGIN_H
...
//!
class HeadLogicNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
