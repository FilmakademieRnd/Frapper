...
#ifndef FACETRACKERNODEPLUGIN_H
#define FACETRACKERNODEPLUGIN_H
...
//!
//! Plugin class for creation of FaceTrackerNode node.
//!
class FaceTrackerNodePlugin : public QObject, public NodeTypeInterface
{
    Q_OBJECT
