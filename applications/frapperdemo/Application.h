...
//!
class  Application : public QApplication, public Ogre::LogListener, public daeErrorHandler
{
...
public: // constructors and destructors
    ...
    //!
    Application ( const QString &organizationName, const QString &applicationName, int &argc, char **argv, const QString &aboutText = "" );
...
private slots: // Scene actions
	...
	//!
	//! Opens an existing layout to be applied on the Viewport.
	//!
	void openViewportLayout ( Window *window  );
...
private: // data
	...
	//!
	//! The name of the file with the currently loaded layout.
	//!
	QString m_currentLayoutFilename;
...
private: // data: menu system
	...
	QAction *m_backdropAction;
    QAction *m_ungroupAction;
    QAction *m_selectAllAction;
	QAction *m_preferencesAction;
	QAction *m_ogreConfiguration;
	QAction *m_selectWorkingDirectoryAction;
