...
//!
StereoBottic::StereoBottic ( const QString &organizationName, const QString &applicationName, int &argc, char **argv, const QString &aboutText /* = "" */ ) :
...

{
    ...
    // application actions
    m_aboutApplicationAction = new QAction(QIcon(":/sb/applicationIcon"), QString("%1 %2").arg(tr("&About")).arg(m_applicationName), this);
    m_aboutFrameworkAction = new QAction(QIcon(":/sb/splash"), tr("About &Frapper"), this);
    m_aboutOgreAction = new QAction(QIcon(":/sb/ogreIcon"), tr("About &OGRE"), this);
    m_aboutQtAction = new QAction(QIcon(":/sb/qtIcon"), tr("About &Qt"), this);
    m_quitAction = new QAction(tr("E&xit"), this);

    // file actions
    m_newSceneAction = new QAction(QIcon(":/sb/newIcon"), tr("&New"), this);
    m_openSceneAction = new QAction(QIcon(":/sb/openIcon"), tr("&Open..."), this);
    m_reloadSceneAction = new QAction(QIcon(":/sb/refreshIcon"), tr("&Reload"), this);
    m_mergeSceneAction = new QAction(tr("&Merge..."), this);
    m_saveSceneAction = new QAction(QIcon(":/sb/saveIcon"), tr("&Save"), this);
    m_saveSceneAsAction = new QAction(tr("Save &As..."), this);
    m_closeSceneAction = new QAction(QIcon(":/sb/closeIcon"), tr("&Close"), this);

    // edit actions
    m_undoAction = new QAction(QIcon(":/sb/undoIcon"), tr("&Undo"), this);
    m_redoAction = new QAction(QIcon(":/sb/redoIcon"), tr("&Redo"), this);
    m_cutAction = new QAction(QIcon(":/sb/cutIcon"), tr("Cu&t"), this);
    m_copyAction = new QAction(QIcon(":/sb/copyIcon"), tr("&Copy"), this);
    m_pasteAction = new QAction(QIcon(":/sb/pasteIcon"), tr("&Paste"), this);
	...
	m_ogreConfiguration = (new QAction(QIcon("../../resources/icons/Ogre.png"), tr("&Ogre Configuration..."), this));
    // view actions
    ...
    m_newWindowAction = new QAction(QIcon(":/sb/addWindowIcon"), tr("&New"), this);
    m_duplicateWindowAction = new QAction(QIcon(":/sb/duplicateWindowIcon"), tr("&Duplicate"), this);
    m_renameWindowAction = new QAction(QIcon(":/sb/editWindowIcon"), tr("&Rename"), this);
    m_closeWindowAction = new QAction(QIcon(":/sb/removeWindowIcon"), tr("&Close"), this);
    m_closeWindowAction2 = new QAction(QIcon(":/sb/removeWindowIcon"), tr("&Close Window"), this);
    m_closeAdditionalWindowsAction = new QAction(QIcon(":/sb/closeWindowsIcon"), tr("Close &All"), this);
    m_openWindowLayoutAction = new QAction(QIcon(":/sb/openIcon"), tr("Open Layout..."), this);
    m_saveDefaultWindowLayoutAction = new QAction(QIcon(":/sb/saveIcon"), tr("Save Default Layout"), this);
    m_saveAsNewWindowLayoutAction = new QAction(QIcon(":/sb/saveIcon"), tr("Save Layout As..."), this);
    m_listWindowsAction = new QAction(QIcon(":/sb/windowsIcon"), tr("&Windows..."), this);
    // help actions
    m_documentationAction = new QAction( QIcon(":/sb/helpIcon"), tr("&Documentation"), this);
    ...
    QPixmap pixmap = QPixmap(":/sb/splash");
    ...
    statusMessage = "\nLoading icons...";
    Log::debug(statusMessage, "StereoBottic::Application");
    splashScreen.showMessage(statusMessage, splashScreenAlignment, splashScreenColor);
    
    // load icons
    Log::loadIcons();
    setWindowIcon(QIcon(":/sb/applicationIcon"));
...
StereoBottic::~StereoBottic ()
{
    ...
    Log::debug("Application destroyed.", "StereoBottic::~Application");
}
...
void StereoBottic::messageLogged ( const Ogre::String &message, Ogre::LogMessageLevel lml, bool maskDebug, const Ogre::String &logName, bool &skipThisMessage )
#else
void StereoBottic::messageLogged ( const Ogre::String &message, Ogre::LogMessageLevel lml, bool maskDebug, const Ogre::String &logName )
#endif
{
#if(OGRE_VERSION >= 0x010800)
	if (skipThisMessage)
...
//!
void StereoBottic::handleError ( daeString msg )
{
...
//!
void StereoBottic::handleWarning ( daeString msg )
{
...
//!
void StereoBottic::handleWindowActivation ( Window *window )
{
...
//!
void StereoBottic::handleWindowRenaming ( Window *window )
{
...
//!
void StereoBottic::handleWindowClosing ( Window *window, QCloseEvent *event )
{
...
//!
void StereoBottic::createWindow ( const QString &panelTypeName, const QPoint &position, const QSize &panelSize )
{
...
//!
void StereoBottic::handleViewPanelCreation ( ViewPanel *viewPanel )
{
...
//!
void StereoBottic::updateActions ( bool objectsSelected )
{
    // update actions
...
//!
void StereoBottic::showNodeContextMenu ( const QPoint &position )
{
...
//!
void StereoBottic::setUpActions ()
{
    /// Application actions
...
void StereoBottic::setUpMenus ()
{
    ...
    for (int i = 0; i < typeNames.size(); ++i) {
        ...
        if (nodeTypeCategoryActions.contains(categoryName)) {
            ...
            Log::warning(QString("Node type category named \"%1\" could not be obtained.").arg(categoryName), "StereoBottic::setUpMenus");
        // create a submenu action for the node type
        QString iconName = ":/sb/pluginIcon";
        if (NodeFactory::isErroneous(typeName))
            iconName = ":/sb/pluginWarningIcon";
...
//!
void StereoBottic::saveSettings ()
{
    //QSettings settings (m_organizationName, m_applicationName);
...
//!
void StereoBottic::setModified ( bool modified )
{
...
//!
void StereoBottic::showStatus ( const QString &message )
{
...
//!
Window * StereoBottic::createWindow ( const QString &layoutName, bool isMainWindow /* = false */ )
{
    QString windowTitle;
    if (isMainWindow)
...
//!
void StereoBottic::addMenus ( Window *targetWindow )
{
...
//!
bool StereoBottic::saveChangesIfNecessary ( const QString &dialogTitle )
{
    if (m_modified) {
        Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
...
//!
void StereoBottic::openScene ( bool clear, bool reload /* = false */ )
{
...
//!
void StereoBottic::openLayout ( QString filename /* = "" */ )
{
    // get name of file to open
    if (filename.isEmpty()) {
        // open a file selection dialog
    ...
    if (!QFile::exists(filename)) {
        Log::error(QString("The file \"%1\" could not be found.").arg(filename), "StereoBottic::openLayout");
        return;
    }
	...
	if (newLayout != 0) {
		...
		Log::error(QString("Error in File \"%1\".").arg(filename), "StereoBottic::openLayout");
}
...
//!
void StereoBottic::loadFile ( const QString &filename )
{
    // check if the file exists
    if (!QFile::exists(filename)) {
        Log::error(QString("The file \"%1\" could not be found.").arg(filename), "StereoBottic::loadFile");
        return;
    }
    ...
    if (rootElement) {
        ...
        Log::error(QString("The file \"%1\" could not be loaded.").arg(filename), "StereoBottic::loadFile");
...
//!
bool StereoBottic::saveFile ( const QString &filename )
{
    QApplication::setOverrideCursor(Qt::WaitCursor);
...
//!
void StereoBottic::setCurrentFilename ( const QString &filename )
{
...
//!
void StereoBottic::showAbout ( const QString &title, const QString &text )
{
    Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
...
//!
void StereoBottic::closeEvent ( QCloseEvent *event )
{
...
//!
void StereoBottic::processOgreMessage ( const QString &message, const QString &level )
{
...
//!
void StereoBottic::unregisterMainWindow ()
{
    m_mainWindow = 0;
}
...
//!
void StereoBottic::showAboutApplication ()
{
...
//!
void StereoBottic::showAboutFramework ()
{
    QString title (qobject_cast<QAction *>(sender())->text().remove('&'));
    QString text (
        "<h3>About Frapper</h3>"
        "This application was built using Frapper version 1.0a, a C++ toolkit for node-based, plugin-powered, panel-oriented, cross-platform 3D application development.<br>"
        "<div align=\"center\">"
        "<a href=\"http://www.filmakademie.de\"><img src=\":/sb/filmakademieLogo\"></a><br>"
        "</div>"
        "The Application Framework has been developed at Filmakademie Baden-Wuerttemberg.<br>"
        "Authors: Stefan Habel, Simon Spielmann, Nils Zweiling<br>"
        "Copyright &copy; 2009 Filmakademie Baden-Wuerttemberg. All rights reserved.<br>"
        "<br>"
...
//!
void StereoBottic::showAboutOgre ()
{
    QString title (qobject_cast<QAction *>(sender())->text().remove('&'));
    QString text (
        "<h3>About OGRE</h3>"
...
//!
void StereoBottic::quitApplication ()
{
    WindowManager::closeAdditionalWindows();
...
//!
bool StereoBottic::saveLayoutAs ()
{
	Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
...
//!
bool StereoBottic::saveDafaultLayout ()
{
...
//!
void StereoBottic::undo ()
{
    Log::na("StereoBottic::undo");
}
...
//!
void StereoBottic::redo ()
{
    Log::na("StereoBottic::redo");
}
...
//!
void StereoBottic::cut ()
{
    Log::na("StereoBottic::cut");
}
...
//!
void StereoBottic::copy ()
{
    QWidget *focusWidget = StereoBottic::focusWidget();
    if (focusWidget) {
        ...
        if (parentWidget) {
            ...
            if (copyHandler)
                ...
                Log::warning("Copying is currently not available for the selected object/GUI element. (Debug information: The element's parent widget is not an implementation of CopyHandler.)", "StereoBottic::copy");
        } else
            Log::warning("Copying is currently not available for the selected object/GUI element.", "StereoBottic::copy");
    }
}
...
//!
void StereoBottic::paste ()
{
    Log::na("StereoBottic::paste");
}
...
//!
void StereoBottic::editPreferences ()
{
}
...
//!
void StereoBottic::editOgreConfiguration ()
{	
	if (QFile::exists("frapperogreconfig.exe")){	
		...
		Log::info("Note that changes to the OGRE render configuration require a restart of the Frapper application.","StereoBottic::Application");
	}
	else 
		Log::error("File not found! OGRE render configuration requires 'frapperogreconfig.exe'.", "StereoBottic::Application");
}
...
//!
void StereoBottic::creationActionTriggered ()
{
...
//!
void StereoBottic::toggleStatusBar ()
{
    Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
    if (activeWindow)
...
//!
void StereoBottic::duplicateActiveWindow ()
{
    Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
    if (activeWindow)
        Log::na("StereoBottic::duplicateActiveWindow");
}
...
//!
void StereoBottic::renameActiveWindow ()
{
    Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
    if (activeWindow) {
        bool result;
...
//!
void StereoBottic::closeActiveWindow ()
{
    Window *activeWindow = qobject_cast<Window *>(this->activeWindow());
    if (activeWindow)
        activeWindow->close();
...
//!
void StereoBottic::closeAdditionalWindows ()
{
    WindowManager::closeAdditionalWindows();
}
...
//!
void StereoBottic::showDocumentation ()
{
